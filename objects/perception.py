...
class ReactiveUnit:
    ...
    def show(self, how="spline"):
        ...
        if how == "hist":
            ...
            result = scipy.integrate.quad(lambda x: 0.5 * f2(x)*f2(x), 0.41, 1.19)
            print(result)
...
class DiscriminativeCategory:
    ...
    def __init__(self, weights=[], reactive_units=[]):
...
#ru = ReactiveUnit(Stimulus(3,4))
#ru2 = ReactiveUnit(Stimulus())
#ru.show()

#c = DiscriminativeCategory()
#c.add_reactive_unit(ru, 0.3)
#c.add_reactive_unit(ru2, 0.6)